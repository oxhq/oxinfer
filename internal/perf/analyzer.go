...
func (pa *PerformanceAnalyzer) calculateEfficiencySeverity(efficiency float64) SeverityLevel {
	switch {
	case efficiency < 0.5: // Less than 50%
		return SeverityCritical
	case efficiency < 0.65: // Less than 65%
		return SeverityHigh
	case efficiency < 0.8:  // Less than 80%
		return SeverityMedium
	default:
		return SeverityLow
	}
