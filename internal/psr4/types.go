...
func (c *ComposerData) HasPSR4Config() bool {
	return (c.Autoload.PSR4 != nil && len(c.Autoload.PSR4) > 0) ||
		(c.AutoloadDev.PSR4 != nil && len(c.AutoloadDev.PSR4) > 0)
}
...
func extractPSR4Mappings(psr4Config map[string]interface{}, isDevDependency bool) ([]NamespaceMapping, error) {
	var mappings []NamespaceMapping
