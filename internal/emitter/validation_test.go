...
func TestComplexDeltaDeterministicValidation(t *testing.T) {
	...
	if broadcasts, ok := result["broadcast"].([]interface{}); ok && len(broadcasts) >= 2 {
		first := broadcasts[0].(map[string]interface{})
		second := broadcasts[1].(map[string]interface{})
...
func deepEqual(t *testing.T, expected, actual interface{}) bool {
